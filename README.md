...
Course: CSC14006 Pattern Recognition (Faculty of IT, VNU-HCM University of Science)
Student: Trần Chí Nguyên
MSSV: 23122044

A ~9-minute ManimGL video on Chapter 12, "Facial Landmark Localization," of the *Handbook
of Face Recognition* (2nd ed., Ding & Wang): the Active Shape Model and RFE-ASM, through to
modern methods (FAN, MediaPipe, 3D mesh).
...
assets (3D hero stills, ~346 MB) are in Releases, since GitHub isn't meant to hold big
binaries inline.
